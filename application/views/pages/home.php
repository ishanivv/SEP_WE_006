    <div class="hero-area">
        ...
        <div class="hero-slider heroflex flexslider clearfix" data-autoplay="yes" data-pagination="no" data-arrows="yes" data-style="fade" data-speed="7000" data-pause="yes">
            <ul class="slides">
            	<li class="parallax" style="background-image:url(images/mugen.jpg);"></li>
                <li class="parallax" style="background-image:url(images/bmwfinal.jpg);"></li>
                <li class="parallax" style="background-image:url(images/2014-Acura.jpg);"></li>
            </ul>
        </div>
        <!-- End Hero Slider -->
    </div>
