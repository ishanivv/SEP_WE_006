            	...
            	<div class="row">
                    <div class="col-md-4">
                    	...
                    	<section class="signup-form sm-margint">
                            <form method="post" action="<?php echo "http://www.autotraders.ga/Login/log"?>">
                            	<!-- Login -->
                                ...
                                <div class="regular-signup">
                                    ...
                                    <br>
                                    <p><a href="http://www.autotraders.ga/Reset_Password">Forgot password?</a></p>
                                    <div>
                                    <p>Don't have an account? <span class="accent-color"><a href="http://www.autotraders.ga/Register">Register here</a></span></p>
                                    </div>
