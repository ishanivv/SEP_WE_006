            	...
            	<div class="row">
                    ...
                    <div class="col-md-4">
                    	<section class="signup-form sm-margint">
                            <form method="post" action="http://localhost:8080/projects/ci/ResetPassword/reset">
                                ...
                                ?>
                                    ...
                                    <div class="spacer-20"></div>
                                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="reset" value="Reset Password">
                                </div>
                            </form>
                        </section>
                    </div>
