			...
			<div class="container">
				<div class="row">
					...
					<section class="signup-form sm-margint">
						...
						<?php
   						...
   						<form name="myForm3" method="post" action="<?php echo base_url().'editAd_ctrl/update_myad/'.$Vehicleid;?>">
					...
					<input type="text" id="filenameOne" name="imgPath1" value=<?php echo $path.$Image1?> />
					...
					<input type="text" id="filenameTwo" name="imgPath2" value=<?php echo $path.$Image2?> />
					...
					<input type="text" id="filenameThree" name="imgPath3" value=<?php echo $path.$Image3?> />
					...
					<input type="text" name="Model" Placeholder="Model*" class="form-control" value="<?php echo $Model;?>">
					<input type="text" name="ModelYear" Placeholder="Model Year*" class="form-control" value="<?php echo $Modelyear;?>">
					
					<select name="VehicleCondition" class="form-control selectpicker">
						<option value="<?php echo $VehicleCondition;?>"><?php echo $VehicleCondition;?></option>
						<option value="condition">Condition*</option>
						<option value="New">New</option>
						<option value="Used">Used</option>
						<option value="Reconditioned">Reconditioned</option>
					</select>
					<input type="text" name="Mileage" placeholder="Mileage*" class="form-control" value="<?php echo $Mileage;?>">
					<select name="BodyType" class="form-control selectpicker">
						<option value="<?php echo $BodyType;?>"><?php echo $BodyType;?></option>
				...
				<?php } ?>
					...
					<input type="text" name="EngineCapacity" placeholder="Engine capacity (cc)*" class="form-control"
					 value="<?php echo $EngineCapacity;?>">

					<div class="spacer-20"></div>
					<input type="text" name="Price" placeholder="Price(Rs.)*" class="col-md-4" value="<?php echo $Price;?>"/>

					<?php if(  $Negotiable == "1") {?>
					<input type="checkbox" name="checkbox5" value="1" class="col-md-1" checked='checked'>Negotiable

					<?php } elseif(  $Negotiable == "0") {?>
