  	...
  	<div class="main" role="main">
    	<div id="content" class="content full">
        	<div class="container">
                            ...
                            <div class="accordion" id="toggleArea">
                                ...
                                <div class="accordion-group">
                                    ...
                                    <?php
                                     	if(isset($model))
                                        {?>
                                    	<input type="text" name="model" placeholder="Model" value="<?php echo $model; ?>" class="form-control" >
                                    <?php	
                                		}
                                		else{
                                    ?>
                                    	...
                                    	<label>Mileage</label>
  										<div class="form-group">
  											<?php
  													if(isset($dis1)) {
  											?>	 
  													<input type="number" name = "dis1" Placeholder="from" value="<?php echo $dis1;?>" class="form-control" />
                                            <?php
                                            		}
                                            		else{
                                            ?>
                                            ...
                                            <?php } 
                                            		if (isset($dis2)) {			
                                            ?>
                                            		<input type="number" name = "dis2" Placeholder="to" value="<?php echo $dis2;?>" class="form-control"/>
                                            <?php 	}
                                            		else{
                                            ?>		
                                    ...
                                    <label>Model Year</label>
  									<div class="form-group">
  											<?php
  													if(isset($year1)) {
  											?>	 
  													<input type="number" name = "year1" Placeholder="from" value="<?php echo $year1;?>" class="form-control" />
                                            <?php
                                            		}
                                            		else{
                                            ?>
                                            ...
                                            <?php } 
                                            		if (isset($dis2)) {			
                                            ?>
                                            		<input type="number" name = "year2" Placeholder="to" value="<?php echo $year2;?>" class="form-control"/>
                                            <?php 	}
                                            		else{
                                            ?>		
                                ...
                                <div class="accordion-group">
  												...
  												<?php
  													if(isset($pria)) {
  												?>	 
  													<input type="number" name = "pria" class="form-control" value="<?php echo $pria;?>" placeholder="from" />
  												<?php	}
  													else{ 
  												?>	
                                                ...
                                                <?php
                                                	...
                                                	if (isset($prib)) {
                                          		?>
                                          			<input type="number" name = "prib" class="form-control" value="<?php echo $prib;?>" placeholder="to" />
                                          		<?php	
                                                	}
                                                	else
                                                	{
            	...
            	<div id="results-holder" class="results-list-view" style="padding-left:40px">
				<div>
				...
				<?php
					...
					foreach($posts as $post){?>
						...
						<div style="width: 540px;height: 200px;float: left;margin:0;padding-left: 10px">
							...
							<div style="width:180px;height:150px;float:left;padding:5px">
