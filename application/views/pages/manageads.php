                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item" id="save"> <span class="badge">2</span> <a href="user-dashboard-saved-cars.html"><i class="fa fa-star-o"></i> Saved Cars</a></li>
                                    <li class="list-group-item"> <a href="http://www.autotraders.ga/postad"><i class="fa fa-plus-square-o"></i> Create new Ad</a></li>
                                    <li class="list-group-item active"> <span class="badge"><?php echo $this->session->userdata['ads']; ?></span> <a href="<?php echo 'http://www.autotraders.ga/my_ads_ctrl/get_my_ads/'.$this->session->userdata['logged_in']['email']?>"><i class="fa fa-edit"></i> Manage Ads</a></li>
