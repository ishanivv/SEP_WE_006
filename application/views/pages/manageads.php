                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item"> <span class="badge">5</span> <a href="<?php echo 'http://localhost/ci/dashboard_ctrl/loadmyads/'.$_SESSION['email']?>"><i class="fa fa-home"></i> Dashboard</a></li>
                                    ...
                                    <li class="list-group-item active"> <span class="badge"><?php echo $_SESSION['ads']; ?></span> <a href="<?php echo 'http://localhost/ci/myads_ctrl/getmyads/'.$_SESSION['email']?>"><i class="fa fa-edit"></i> Manage Ads</a></li>
