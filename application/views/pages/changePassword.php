                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"> <a href="http://www.autotraders.ga/select_location"><i class="fa fa-plus-square-o"></i> Create new Ad</a></li>
                                    <li class="list-group-item"> <span class="badge"><?php echo $this->session->userdata['logged_in']['ads']; ?></span> <a href="<?php echo 'http://www.autotraders.ga/my_ads_ctrl/get_my_ads/'.$this->session->userdata['logged_in']['email']?>"><i class="fa fa-edit"></i> Manage Ads</a></li>
                                    <li class="list-group-item active"> <a href="http://www.autotraders.ga/New_Password"><i class="fa fa-user"></i> My Profile</a></li>
                            ...
                            <div class="dashboard-block">
                                <div class="tabs profile-tabs">
                                    <ul class="nav nav-tabs">
                                        <li> <a data-toggle="tab" href="#personalinfo" aria-controls="personalinfo" role="tab">Personal Info</a></li>
                                        <li class="active"> <a data-toggle="tab" href="#changepassword" aria-controls="changepassword" role="tab">Change Password</a></li>
                                    </ul>
