                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"> <span class="badge"><?php echo $this->session->userdata['logged_in']['ads']; ?></span> <a href="<?php echo 'http://localhost/ci/myads_ctrl/getmyads/'.$this->session->userdata['logged_in']['email']?>"><i class="fa fa-edit"></i> Manage Ads</a></li>
