...
<body>
			<div class="container">
				...
				<?php
					...
					<p>Dear Customer, </p>
					<p>This ad is available for your saved search. To view this ad <a href="<?php echo 'http://www.autotraders.ga/adpreview_ctrl/getad_preview/'.$vehicleid?>">Click here</a></p>
				</div>
