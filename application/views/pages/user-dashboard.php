                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4 users-sidebar-wrapper">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item active"> <span class="badge">5</span> <a href="<?php echo 'http://localhost/ci/dashboard_ctrl/loadmyads/'.$this->session->userdata['logged_in']['email']?>"><i class="fa fa-home"></i> Dashboard</a></li>
